            ...
            <td><table width="92%" align="center">
                <tr>
                  <td colspan="2" align="center" valign="middle" class="td-text"><div class="input-group"> <span class="input-group-addon" style="width:30%">ACC_PASSWORD_TITLE_OLD</span>
                      <input type="password" class="form-control form-control-righttext"  id="accpass.txt.passwordold" placeholder="COM_TXT_INPUT_PLACEHOLDER" onFocus='javascript:setKeyboardFocus("accpass.txt.passwordold"); javascript:setFieldFocus("accpass.txt.passwordold")' onblur="onBlurPassword('0')" onkeypress='javascript:disableKey(event);' autocomplete="off"  maxlength="16"/>
                ...
                <tr>
                  <td colspan="2" align="center" valign="middle" class="td-text"><div class="input-group"> <span class="input-group-addon" style="width:30%">ACC_PASSWORD_TITLE_NEW</span>
                      <input type="password" class="form-control form-control-righttext"  id="accpass.txt.passwordnew" placeholder="COM_TXT_INPUT_PLACEHOLDER" onFocus='javascript:setKeyboardFocus("accpass.txt.passwordnew"); javascript:setFieldFocus("accpass.txt.passwordnew")' onblur="onBlurPassword('0')" onkeypress='javascript:disableKey(event);' autocomplete="off"  maxlength="16"/>
                      <span class="input-group-addon input-group-symbol"></span> </div></td>
                </tr>
                <tr>
                                  ...
                                  <tbody>
                                    ...
                                    <tr style="display:none;">
                                      <td style="text-align:left;border:none;color:#FFFFFF" colspan="6"><input type="checkbox" name="elemC4" id="elemC4"/>
                                        <nobr>Nh?p m?t kh?u b?ng cách di chu?t</nobr></td>
                                    </tr>
                                  </tbody>
                                </table>
                                </span></td>
                ...
                <tr> 
                  ...
                  <td  align="right" width='50%'><input type="button" class="btnshadow btn-second" id="accpass.btn.moreinfo"
									onclick="requestChangePassword()" value="REVIEW_BTN_CONFIRM" /></td>
                </tr>
              </table></td>
          </tr>
        </table>
